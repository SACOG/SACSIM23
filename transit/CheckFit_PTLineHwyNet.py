...
INSTRUCTIONS:
    ...
    2 - near the end of this script, in the parameters, specify the file paths to
        the link DBF and transit line TXT, and whether you want to flag only missing links,
        or also flag links on which the transit line may be traveling the wrong direction.
